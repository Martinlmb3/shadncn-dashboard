    ...
    const handleChange = (id, field, value) => {
        if (!/^\d*\.?\d*$/.test(value)) {
            setProducts((prevProducts) => 
                prevProducts.map((product) => product.id === id? {...product, [field]: Number(value)}: product))
        }
    }
                ...
                <thead>
                    <tr>
                        {[
                            ...
                            <th key={header} className="px-3 md:px-6 md:py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hidden md:table-cell">
                                {header}
                            </th>
                        ))}
                    </tr>
                ...
                <tbody className="divide-y divide-gray-200">
                        {filteredProducts.map((product) => (
                            <motion.tr
                                ...
                                className={`flex-col md:table-row mb-4 md:mb-0 border-b md:border-0 border-gray-700 md:border-none p-2 md:p-0 
                                    ...
                                    <div className="mt-2 text-xs text-gray-300">
                                        ...
                                        {["price","stock","sales"].map((field) => (
                                            <div key={field}>
                                                ...
                                                {editingRow === product.id ? (<input type="text" 
