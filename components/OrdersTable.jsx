    ...
    >
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-700">
          <thead>
            <tr>
              {["Order ID", "Client", "Total", "Status", "Date", "Country", "Actions"].map((header) => (
                <th
                  key={header}
          ...
          <tbody className="divide-y divide-gray-700">
            {filteredOrders.map((order) => (
              ...
              >
                ...
                {/*Desktop View */}
                <td className="hidden md:table-cell px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-200">
                  {order.id}
                </td>
                <td className="hidden md:table-cell px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-200">
                  {order.client}
